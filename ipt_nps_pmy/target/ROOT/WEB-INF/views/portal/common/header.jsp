...
<head>
    ...
    <script src="/js/utils/date-util.js"></script>
    ...
    function getLayerPage( total, cpage, viewCount) {
        var retStr = '';
        ...
        if(total > viewCount) {
            ...
            if(cpage > 1) {
                retStr += '<a href=\"javascript:doPagingClickLayer(\'1\')\" class=\"first\"><img src=\"/images/btn_first.png\" alt=\"처음으로\"></a>'; // 첫페이지
            } else {
                // retStr += '<span class=\"mgr\"><a href=\"#\"><img src=\"/resources/admin/images/btn_pageFirst.gif\" alt=\"처음으로\"></a></span>'; // 첫페이지
            }
            ...
            if(page_start > 10) {
                var h = page_start - 1;
                retStr += '<a href=\"javascript:doPagingClickLayer(\'' + h + '\')\" class=\"prev\"><img src=\"/images/btn_prev.png\" alt=\"이전\"></a>';
            }
            ...
            for(var i = page_start; i <= page_end; i++) {
                ...
                if(i == cpage){
                    ...
                    retStr += '<a href=\"javascript:doPagingClickLayer(\'' + i + '\')\">' + i + '</a>';
                }
            }
            ...
            if(page_end < total_page) {
                var k = page_end + 1;
                retStr += '<a href=\"javascript:doPagingClickLayer(\'' + k + '\')\" class=\"next\"><img src=\"/images/btn_next.png\" alt=\"다음\"></a>';
            } else {
                // retStr += '<span class=\"page_div\">|</span> <span class=\"page_bt\">다음</span>'; // 다음10개
            }

            if(cpage < total_page) {
                retStr += '<a href=\"javascript:doPagingClickLayer(\'' + total_page + '\')\" class=\"last\"><img src=\"/images/btn_last.png\" alt=\"끝으로\"></a>'; // 마지막페이지
            } else {
                // retStr += '<span class=\"page_arrow\">▶</span>'; // 마지막페이지
            }
