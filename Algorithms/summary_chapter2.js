    ...
    2. 대표적인 수행 시간의 형태 
        ...
        3. 지수시간 알고리즘 
            1. 다항 시간 알고리즘 
                ...
                3. 다항시간 알고리즘 보다 훨씬 오래 걸리는 알고리즘이 있다. >> 지수시간알고리즘 이다.
            ...
            2. 지수 시간 알고리즘
                ...
                2. 이와 같이 N이 하나 증가할 때마다 걸리는 시간이 배로 증가하는 알고리즘들은 지수시간에 동작한다고 말한다.
                3. 지수시간은 가장 큰 수행시간 중 하나이다. 입력 크기에 따라 다항시간과는 비교도 안되게 빠르게 증가한다. 
                4. 문제에 따라 지수시간알고리즘을 써야할수 밖에 없는 문제들이 있다. 
                5. 때문에 다항시간 알고리즘으로도 문제를 풀 수 있느냐? 지수시간알고리즘으로만 풀 수 있느냐?에 따라 그 문제가
                계산적으로 어려운 문제인지 쉬운 문제인지 결정된다.
                6. 물론 계산적으로 어려운 문제라고 해서 무조건 더 효율적인 방법이 없는 것은 아니다. 
                    1. 11장에서는 지수시간이 걸리는 문제들을 좀 더 효율적으로 해결할 수 있는 방법이 나와있다.
                    2. 그러나 이것들이 지수시간을 >>> 다항시간으로 바꿔주진 못하며 다항시간 보다 느린것은 마찬가지이다.
